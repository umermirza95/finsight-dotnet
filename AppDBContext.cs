...
public class AppDbContext : IdentityDbContext<FSUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FSTransactionSuggestion>(entity =>
       {
           entity
               .HasOne<FSUser>()
               .WithMany()
       ...
       .IsUnique();
        ...
        modelBuilder.Entity<FSImportedTransaction>(entity =>
        {
            ...
            entity
                .HasOne(t => t.FSTransaction)
                .WithMany(t => t.FSImportedTransactions)
        ...
        modelBuilder.Entity<FSPushSubscription>(entity =>
        {
